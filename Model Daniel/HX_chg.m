function [Q_AHT,P_out_air,T_out_air,m_dot_cool,T_out_cool,Irr] = HX_chg(m_dot_air,T_in_air,P_in_air,cp_cool,T_in_cool,epsilon,C_r,DP_air,CP,beta_a,T_a,wf)
...
Irr = T_a*(m_dot_cool*cp_cool*log(T_out_cool/T_in_cool)- m_dot_air*cp_air_mean*log(T_in_cool/T_out_air)) + m_dot_air*287*T_a*log(P_in_air/P_out_air); 
