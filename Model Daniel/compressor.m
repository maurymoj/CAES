function [W_dot, P_out,T_out,Irr] = compressor(m_dot,P_in,T_in,PR,eta_iso,wf,CP,beta_a,T_a)
%Compressor function
%{
Inputs: m_dot,P_in,T_in,PR,eta_iso,wf,CP
Outputs: W_dot, P_out,T_out,Irr

Using definition of isentropic efficiency for compressors, outlet
...
Irr = W_dot - abs(m_dot*(xi_in - xi_out)); % Irreversibility
